...
QT_MOC_LITERAL(1, 9, 6), // "charge"
QT_MOC_LITERAL(2, 16, 0), // ""
QT_MOC_LITERAL(3, 17, 12) // "rechargeInfo"

    },
    "recharge\0charge\0\0rechargeInfo"
};
...
void recharge::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->charge((*reinterpret_cast< const rechargeInfo(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (recharge::*_t)(const rechargeInfo & );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&recharge::charge)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject recharge::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_recharge.data,
      qt_meta_data_recharge,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void recharge::charge(const rechargeInfo & _t1)
{
