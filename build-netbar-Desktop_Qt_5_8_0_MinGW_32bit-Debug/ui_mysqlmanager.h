...
public:
    ...
    void setupUi(QMainWindow *mysqlManager)
    {
        ...
        horizontalLayoutWidget->setGeometry(QRect(560, 320, 160, 21));
        ...
        qRecord = new QPushButton(useRecord);
        qRecord->setObjectName(QStringLiteral("qRecord"));
        qRecord->setGeometry(QRect(180, 390, 75, 23));
        ...
        qRepair->setGeometry(QRect(150, 360, 75, 23));
        ...
        mRepair->setGeometry(QRect(460, 360, 75, 23));
    ...
    void retranslateUi(QMainWindow *mysqlManager)
    {
        ...
        qRecord->setText(QApplication::translate("mysqlManager", "\346\237\245\350\257\242", Q_NULLPTR));
