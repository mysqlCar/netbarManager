...
public:
    ...
    void setupUi(QDialog *repair)
    {
        ...
        errNum = new QComboBox(horizontalLayoutWidget_2);
    ...
    void retranslateUi(QDialog *repair)
    {
        ...
        errNum->clear();
        errNum->insertItems(0, QStringList()
         << QApplication::translate("repair", "\347\241\254\344\273\266\346\225\205\351\232\234", Q_NULLPTR)
         << QApplication::translate("repair", "\350\275\257\344\273\266\346\225\205\351\232\234", Q_NULLPTR)
        );
    } // retranslateUi
